...
#define STUDIO_NF_FLATSHADE		0x0001	// ambient lighting only
...
// mesh flags
#define STUDIO_HAS_BUMP		BIT( 0 )	// need to recalc tangent space
#define STUDIO_HAS_CHROME		BIT( 1 )	// need to recalc chrome coords
